...
const AnalyticsModal: React.FC = () => {
  ...
  return (
    <div className=" px-6 py-6 bg-slate-900 rounded-lg shadow-lg border border-slate-700" style={{margin: '0 3rem 3rem 3rem'}}>
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              {/* <h1 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-blue-300">
                Success Metrics Dashboard
              </h1> */}
              <h2 className="text-slate-400 text-sm mt-1">
